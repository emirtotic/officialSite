						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">List of emails who downloaded CV</h3>
								...
								<div class="card-body">
									<table class="table table-bordered">
										...
										<tbody id="sort-list">
											...
											<c:forEach var="downloaders" items="${downloadersList}">

												<tr>
													<td>${downloaders.id}</td>
													<td><strong>${downloaders.email}</strong></td>

													<td class="text-center">
														<div class="btn-group">
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${downloaders.id}">
												...
												<div class="modal fade" id="delete-modal-${downloaders.id}">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title">Delete Downloader</h4>
															...
															<div class="modal-body">
																<p>Are you sure you want to delete this contact from evidence?</p>
																<strong></strong>
															</div>
															<div class="modal-footer justify-content-between">
																<button type="button" class="btn btn-default"
																	data-dismiss="modal">Cancel</button>
																<a href="downloads-delete?id=${downloaders.id}"
